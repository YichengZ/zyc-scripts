...
Config.STATS_BOX_TEXT_OFFSET_X = -0.004  -- StatsBox 文本水平偏移（相对于box宽度）
Config.STATS_BOX_TEXT_OFFSET_Y = -0.053  -- StatsBox 文本垂直偏移（相对于box高度）
...
function Config.load_from_data(global_stats)
  ...
  Config.STATS_BOX_TEXT_OFFSET_X = settings.stats_box_text_offset_x or -0.004
  Config.STATS_BOX_TEXT_OFFSET_Y = settings.stats_box_text_offset_y or -0.053
