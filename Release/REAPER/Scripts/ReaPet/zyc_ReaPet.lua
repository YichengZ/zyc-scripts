...
--   # Zyc ReaPet
--
--   Zyc ReaPet is a cute productivity companion designed specifically for
--   REAPER users, helping you stay motivated and track your creative workflow.
--
--   ### Key Features
...
--
--   Stay motivated and enjoy your creative workflow with your adorable companion!
-- @provides
--   config.lua
--   core/*.lua
--   utils/*.lua
...
PomodoroPresets.init(nil)
PomodoroPresets.apply_to_timer(Pomodoro)
  ...
  if settings_open then
    ...
    if type(result) == "table" then
      ...
      if result.factory_reset then
        ...
        ShopSystem.reset()
        -- 切换回默认猫猫皮肤
        SkinManager.set_active_skin("cat_base")
        local global_stats = tracker:get_global_stats()
        Config.save_to_data(global_stats)
        SaveAllDataAtomic()
