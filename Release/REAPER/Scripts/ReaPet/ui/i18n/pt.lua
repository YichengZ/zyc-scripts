...
local translations = {
  ...
  settings = {
    ...
    general = {
      ...
      stats_box_use_monospace = "Usar fonte monoespaçada para números",
      stats_box_use_monospace_tooltip = "Usar fonte monoespaçada para garantir larguras consistentes dos números (ajuda com problemas de exibição em alguns dispositivos Windows)",
    ...
    system = {
      ...
      warning_reset_message = "Esta ação não pode ser desfeita ⚠️",
      confirm_factory_title = "Confirmar redefinição de fábrica",
      confirm_factory_message = "Esta ação não pode ser desfeita ⚠️",
      confirm_button = "Confirmar",
      cancel_button = "Cancelar",
      show_reset_options = "Ativar opções de redefinição",
  ...
  shop = {
    ...
    earn_tip = "Dica: Clique no cronômetro da janela principal e complete sessões de foco para ganhar moedas!",
    close = "Fechar",
    purchase = "Comprar",
    cancel = "Cancelar",
    balance = "Saldo",
  ...
  welcome = {
    ...
    subtitle = "Seu pequeno companheiro no REAPER ～ (Role para baixo para ver o guia completo)",
    ...
    coins_3 = "   • Você pode ganhar até 800 moedas por dia",
