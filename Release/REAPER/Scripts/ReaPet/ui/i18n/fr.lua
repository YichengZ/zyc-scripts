...
local translations = {
  ...
  settings = {
    ...
    stats = {
      ...
      -- 【Optimized】
      reset_daily_limit_description = "Réinitialiser la limite (Reposez-vous !)",
      reset_project_stats = "Données du projet",
      reset_project_stats_description = "Effacer les stats de ce projet (temps, opérations). Irréversible.",
      reset_project_stats_button = "Réinitialiser les données"
    },
    system = {
      about = "À propos",
      ...
      warning_reset_message = "Cette action ne peut pas être annulée ⚠️",
      confirm_factory_title = "Confirmer la réinitialisation d'usine",
      confirm_factory_message = "Cette action ne peut pas être annulée ⚠️",
      confirm_button = "Confirmer",
      cancel_button = "Annuler",
      show_reset_options = "Activer les options de réinitialisation",
  ...
  welcome = {
    ...
    subtitle = "Votre petit compagnon dans REAPER ～ (Faites défiler vers le bas pour voir le guide complet)",
