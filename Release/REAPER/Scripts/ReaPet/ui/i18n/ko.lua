...
local translations = {
  ...
  settings = {
    ...
    system = {
      ...
      confirm_reset_title = "재설정 확인",
      warning_reset_message = "이 작업은 되돌릴 수 없습니다 ⚠️",
      confirm_factory_title = "공장 초기화 확인",
      confirm_factory_message = "이 작업은 되돌릴 수 없습니다 ⚠️",
      confirm_button = "확인",
      cancel_button = "취소",
      show_reset_options = "재설정 옵션 활성화",
  ...
  welcome = {
    ...
    subtitle = "REAPER에서 함께할 동물 친구 ～ (전체 가이드를 보려면 아래로 스크롤)",
    quick_guide = "📚 빠른 가이드",
    stats_title = "📊 통계 숫자",
