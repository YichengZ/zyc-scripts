...
local translations = {
  ...
  settings = {
    ...
    system = {
      ...
      open_startup_actions = "Open Startup Actions",
      startup_actions_description = "  Manage startup actions and set ReaPet to run on REAPER launch",
      exit = "Exit",
  ...
  welcome = {
    ...
    startup_actions_2 = "   • Manage startup actions in one place",
    startup_actions_3 = "   • Click the button below to set it up",
    startup_actions_button = "Open Startup Actions",
