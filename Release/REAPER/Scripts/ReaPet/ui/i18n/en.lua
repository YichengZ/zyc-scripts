...
local translations = {
  ...
  settings = {
    ...
    system = {
      ...
      startup_actions = "Auto-start Manager",
      open_startup_actions = "Open Auto-start Manager",
  ...
  welcome = {
    ...
    startup_actions_title = "🚀 Auto-start",
    ...
    startup_actions_button = "Open Auto-start Manager",
