...
local translations = {
  ...
  settings = {
    ...
    stats = {
      ...
      -- 【Optimized】
      reset_daily_limit_description = "Tageslimit zurücksetzen (Ruh dich aus!)",
      reset_project_stats = "Projektdaten",
      reset_project_stats_description = "Alle Statistiken für dieses Projekt löschen. Nicht widerruflich.",
      reset_project_stats_button = "Daten zurücksetzen"
    },
    system = {
      about = "Über",
      ...
      warning_reset_message = "Diese Aktion kann nicht rückgängig gemacht werden ⚠️",
      confirm_factory_title = "Werkseinstellung bestätigen",
      confirm_factory_message = "Diese Aktion kann nicht rückgängig gemacht werden ⚠️",
      confirm_button = "Bestätigen",
      cancel_button = "Abbrechen",
      show_reset_options = "Zurücksetzoptionen aktivieren",
  ...
  welcome = {
    ...
    subtitle = "Dein kleiner Begleiter in REAPER ～ (Nach unten scrollen, um die vollständige Anleitung zu sehen)",
