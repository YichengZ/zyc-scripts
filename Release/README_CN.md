...
- **REAPER**: 版本 7.0 或更高（必需）
- **ReaImGui**: 版本 0.10.0.2 或更高（ReaPet 和 Startup Actions 必需）
- **SWS Extension**: 推荐（部分功能需要）
- **ReaPack**: 安装必需

> 💡 **提示**：如果看到 ReaImGui 或 REAPER 版本过旧的错误提示，脚本会提供详细的更新指引。
...
### zyc_ReaPet v1.0.5.2
- 添加 REAPER 7.0 版本要求检测
- 改进 ReaImGui 版本过旧错误提示，提供 ReaPack 更新指引
